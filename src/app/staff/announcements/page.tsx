...
function AnnouncementCard({
  ...
  // Check if this announcement is relevant to teachers
  const isRelevant = 
...
export default function StaffAnnouncementsPage() {
  ...
  const fetchAnnouncements = useCallback(async () => {
    ...
    try {
      ...
      const teacherAnnouncements = announcementsWithNames.filter((a: any) => 
        a.target_audience === 'all' || a.target_audience === 'teachers'
      )

      setAnnouncements(teacherAnnouncements)

      const total = teacherAnnouncements.length
      setStats({ total, unread: 0, read: total })
  ...
  return (
    <div className="min-h-screen bg-slate-50">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-slate-500 flex items-center gap-2">
                  <span>School announcements for staff</span>
                  <span className="text-slate-300">·</span>
            ...
            <CardContent className="py-12 text-center">
              ...
              <p className="text-sm text-slate-400 max-w-sm mx-auto">
                {searchQuery
                  ...
                  : 'No announcements have been published for staff yet.'}
              </p>
            </CardContent>
          </Card>
        ) : (
      ...
      <div className="text-center text-xs text-slate-400 pt-4 border-t border-slate-200/50">
        <p>Vincollins Schools Staff • Announcements</p>
